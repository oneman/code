...
#line 1 "../../../gmp-20241204172630/demos/calc/calc.y"
...
union YYSTYPE
{
#line 142 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 173 "../../../gmp-20241204172630/demos/calc/calc.y"
              { sp = stack[0]; yyerrok; }
#line 1508 "calc.c"
    break;

  case 8: /* statement: e  */
#line 177 "../../../gmp-20241204172630/demos/calc/calc.y"
      {
...
#line 182 "../../../gmp-20241204172630/demos/calc/calc.y"
                   {
...
#line 188 "../../../gmp-20241204172630/demos/calc/calc.y"
            { calc_help (); }
#line 1535 "calc.c"
    break;

  case 11: /* statement: HEX  */
#line 189 "../../../gmp-20241204172630/demos/calc/calc.y"
            { ibase = 16; obase = -16; }
#line 1541 "calc.c"
    break;

  case 12: /* statement: DECIMAL  */
#line 190 "../../../gmp-20241204172630/demos/calc/calc.y"
            { ibase = 0;  obase = 10; }
#line 1547 "calc.c"
    break;

  case 13: /* statement: QUIT  */
#line 191 "../../../gmp-20241204172630/demos/calc/calc.y"
            { exit (0); }
#line 1553 "calc.c"
    break;

  case 15: /* e: e '+' e  */
#line 198 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_add    (sp, sp, sp+1); }
#line 1559 "calc.c"
    break;

  case 16: /* e: e '-' e  */
#line 199 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_sub    (sp, sp, sp+1); }
#line 1565 "calc.c"
    break;

  case 17: /* e: e '*' e  */
#line 200 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_mul    (sp, sp, sp+1); }
#line 1571 "calc.c"
    break;

  case 18: /* e: e '/' e  */
#line 201 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_fdiv_q (sp, sp, sp+1); }
#line 1577 "calc.c"
    break;

  case 19: /* e: e '%' e  */
#line 202 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_fdiv_r (sp, sp, sp+1); }
#line 1583 "calc.c"
    break;

  case 20: /* e: e '^' e  */
#line 203 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 205 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 207 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { CHECK_UI ("Shift count", sp);
...
#line 1604 "calc.c"
  ...
  case 23: /* e: e '!'  */
#line 209 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 1611 "calc.c"
  ...
  case 24: /* e: '-' e  */
#line 211 "../../../gmp-20241204172630/demos/calc/calc.y"
                           { mpz_neg (sp, sp); }
#line 1617 "calc.c"
    break;

  case 25: /* e: e '<' e  */
#line 213 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) <  0); }
#line 1623 "calc.c"
    break;

  case 26: /* e: e LE e  */
#line 214 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) <= 0); }
#line 1629 "calc.c"
    break;

  case 27: /* e: e EQ e  */
#line 215 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) == 0); }
#line 1635 "calc.c"
    break;

  case 28: /* e: e NE e  */
#line 216 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) != 0); }
#line 1641 "calc.c"
    break;

  case 29: /* e: e GE e  */
#line 217 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) >= 0); }
#line 1647 "calc.c"
    break;

  case 30: /* e: e '>' e  */
#line 218 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_cmp (sp, sp+1) >  0); }
#line 1653 "calc.c"
    break;

  case 31: /* e: e LAND e  */
#line 220 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_sgn (sp) && mpz_sgn (sp+1)); }
#line 1659 "calc.c"
    break;

  case 32: /* e: e LOR e  */
#line 221 "../../../gmp-20241204172630/demos/calc/calc.y"
                  { sp--; mpz_set_ui (sp, mpz_sgn (sp) || mpz_sgn (sp+1)); }
#line 1665 "calc.c"
    break;

  case 33: /* e: ABS '(' e ')'  */
#line 223 "../../../gmp-20241204172630/demos/calc/calc.y"
                                 { mpz_abs (sp, sp); }
#line 1671 "calc.c"
    break;

  case 34: /* e: BIN '(' e ',' e ')'  */
#line 224 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 1678 "calc.c"
  ...
  case 35: /* e: FIB '(' e ')'  */
#line 226 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 1685 "calc.c"
  ...
  case 37: /* e: KRON '(' e ',' e ')'  */
#line 229 "../../../gmp-20241204172630/demos/calc/calc.y"
                                 { sp--; mpz_set_si (sp,
...
#line 1692 "calc.c"
  ...
  case 39: /* e: LUCNUM '(' e ')'  */
#line 232 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 234 "../../../gmp-20241204172630/demos/calc/calc.y"
                                 { mpz_nextprime (sp, sp); }
#line 1705 "calc.c"
    break;

  case 41: /* e: POWM '(' e ',' e ',' e ')'  */
#line 235 "../../../gmp-20241204172630/demos/calc/calc.y"
                                 { sp -= 2; mpz_powm (sp, sp, sp+1, sp+2); }
#line 1711 "calc.c"
    break;

  case 42: /* e: ROOT '(' e ',' e ')'  */
#line 236 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 1718 "calc.c"
  ...
  case 43: /* e: SQRT '(' e ')'  */
#line 238 "../../../gmp-20241204172630/demos/calc/calc.y"
                                 { mpz_sqrt (sp, sp); }
#line 1724 "calc.c"
    break;

  case 44: /* e: VARIABLE  */
#line 240 "../../../gmp-20241204172630/demos/calc/calc.y"
               {
        sp++;
        CHECK_OVERFLOW ();
...
#line 1735 "calc.c"
  ...
  case 45: /* e: NUMBER  */
#line 246 "../../../gmp-20241204172630/demos/calc/calc.y"
             {
        sp++;
        CHECK_OVERFLOW ();
...
#line 258 "../../../gmp-20241204172630/demos/calc/calc.y"
                     { sp--; mpz_gcd (sp, sp, sp+1); }
#line 1755 "calc.c"
    break;

  case 49: /* lcmlist: lcmlist ',' e  */
#line 262 "../../../gmp-20241204172630/demos/calc/calc.y"
...
#line 264 "../../../gmp-20241204172630/demos/calc/calc.y"
